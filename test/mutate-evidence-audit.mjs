...
const MUTATIONS = [
  ...
  { label: "evidence-v1-har-not-required", file: "audit", from: "  const required = meta.completeness.network !== \"missing\";", to: "  const required = false;", breaks: ["v1 network completeness requires HAR presence"] },
